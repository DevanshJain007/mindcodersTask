...
const Pagination = () => {
  ...
  const newData=questions.slice(start,end);
    const handleNext=()=>{
          ...
          <div>
            ...
            {newData.map((que, index) => (
              <div key={index}>
                ...
                <div>
                <button type='button' onClick={handlePrevious}  disabled={start === 0}>Previous</button>
                <button type='button' onClick={handleNext}     disabled={end >= questions.length}>Next</button>
                </div>
              </div>
            ))}
          </div>
